...
func (lottery *PoSpace) mineOnSingleBlock(proverSingleton chan Parties.Prover, vk string, miningLocation MiningLocation, winningDraws chan LotteryDraw) {
	...
	qualityIsGoodEnough := 0.99 < quality //TODO, One could use the best known total sum of N in network to calculate what quality would give a realistic chance to win
